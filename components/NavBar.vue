    ...
    <div class="flex items-center justify-between bg-indigo-600 px-1 py-2">
      ...
      <div class="hidden md:block">
        <ul style="list-style: none" class="flex space-x-8">
          ...
          <li><a href="/planning" class="text-white">學習規劃</a></li>
          <li><a href="/basic" class="text-white">開發基礎</a></li>
          <li><a href="/frontend" class="text-white">前端開發</a></li>
          <li><a href="/backend" class="text-white">後端開發</a></li>
          <li><a href="/inheritance" class="text-white">經驗傳承</a></li>
          <li>
            <a
              href="/memo"
      ...
      >
        ...
        <ul style="list-style: none" class="divide-y text-gray-700">
          ...
          <li>
            <a href="/basic" @click="isOpen = false" class="my-2 inline-block"
              >開發基礎</a
            >
          </li>
          <li>
          ...
          <li>
            <a href="/backend" @click="isOpen = false" class="my-2 inline-block"
              >後端開發</a
            >
          </li>
          <li>
